...
## constant variation within each group -- region four has smaller variation than the rest, but not dramaticaly so
...
sum(beta * c(1, 0, 0, 0))               # region 1
sum(beta * c(1, 1, 0, 0))               # region 2
sum(beta * c(1, 0, 1, 0))               # region 3
sum(beta * c(1, 0, 0, 1))               # region 4
